...
class FeedbackService {
  ...
  Future<void> review(
    ...
    String? text,
      ...
      _client.post('/clients/me/orders/$orderId/review', body: {
        'rating': rating,
        'tags': tags,
  ...
  Future<void> complaint(
    ...
    required String description,
      ...
      _client.post('/clients/me/orders/$orderId/complaint',
...
class MasterPublicProfile {
  ...
  factory MasterPublicProfile.fromJson(Map<String, dynamic> j) => MasterPublicProfile(
...
class PublicReview {
  const PublicReview({required this.id, required this.rating, this.text, this.clientName});
  final int id;
  final int rating;
  final String? text;
...
class MasterPublicService {
  MasterPublicService({ApiClient? client}) : _client = client ?? ApiClient.instance;
  final ApiClient _client;
